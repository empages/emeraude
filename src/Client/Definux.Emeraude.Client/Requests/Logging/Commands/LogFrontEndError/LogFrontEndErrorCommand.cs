...
namespace Definux.Emeraude.Client.Requests.Logging.Commands.LogFrontEndError
{
    /// <summary>
    /// Command for log front-end error.
    /// </summary>
    public class LogFrontEndErrorCommand : IRequest<SimpleResult>, IMapFrom<ErrorLog>
    {
        /// <summary>
