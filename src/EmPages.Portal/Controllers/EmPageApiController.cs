...
/// </summary>
[Route($"{EmPortalConstants.RouteApiPrefix}/page/")]
public class EmPageApiController : EmPortalApiController
{
    private readonly IEmRouter router;
    private readonly IEmPageHandler pageHandler;

    /// <summary>
    /// Initializes a new instance of the <see cref="EmPageApiController"/> class.
    /// </summary>
    /// <param name="router"></param>
    /// <param name="pageHandler"></param>
    public EmPageApiController(
        IEmRouter router,
