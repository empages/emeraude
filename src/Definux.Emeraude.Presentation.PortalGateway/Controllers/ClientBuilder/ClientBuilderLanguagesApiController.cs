...
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.CreateContentKeyWithContent;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.CreateKeyWithValues;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.CreateLanguage;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.DeleteContentKey;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.DeleteKey;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.DeleteLanguage;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.EditContentKeyWithContent;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.EditLanguage;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.EditTranslationKeyWithValues;
using Definux.Emeraude.Application.ClientBuilder.Requests.Commands.MakeLanguageDefault;
using Definux.Emeraude.Application.ClientBuilder.Requests.Queries.GetLanguages;
using Definux.Emeraude.Application.ClientBuilder.Requests.Queries.GetStaticContentKey;
using Definux.Emeraude.Application.ClientBuilder.Requests.Queries.GetStaticContentKeys;
using Definux.Emeraude.Application.ClientBuilder.Requests.Queries.GetTranslationsGridData;
...
namespace Definux.Emeraude.Presentation.PortalGateway.Controllers.ClientBuilder
{
    /// <summary>
