...
namespace Definux.Emeraude.Admin.EmPages.UI.Adapters
{
    ...
    /// </summary>
    public interface IEmPageDataService
    {
        /// <summary>
        ...
        /// <summary>
        /// Submit form view data for processing.
        /// </summary>
        /// <param name="formType"></param>
        /// <param name="schema"></param>
        /// <param name="formViewData"></param>
        /// <returns></returns>
        Task<EmPageFormSubmissionResponse> SubmitFormViewDataAsync(
