...
{
    /// <summary>
    /// Abstract definition for Logger request handler.
    /// </summary>
    ...
    public abstract class LoggerRequestHandler<TRequest, TResult, TLoggerEntity, TLoggerEntityViewModel> : IRequestHandler<TRequest, TResult>
        where TRequest : LoggerRequest<TResult>
        ...
        where TLoggerEntityViewModel : LogEntityViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LoggerRequestHandler{TRequest, TResult, TLoggerEntity, TLoggerEntityViewModel}"/> class.
        /// </summary>
        /// <param name="loggerContext"></param>
        /// <param name="entityContext"></param>
        /// <param name="mapper"></param>
        public LoggerRequestHandler(ILoggerContext loggerContext, IEmContext entityContext, IMapper mapper)
        {
