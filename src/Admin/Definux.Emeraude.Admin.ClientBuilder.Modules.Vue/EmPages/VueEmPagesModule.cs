using Definux.Emeraude.Admin.ClientBuilder.Modules.Vue.EmPages.Templates;
...
namespace Definux.Emeraude.Admin.ClientBuilder.Modules.Vue.EmPages
{
    public class VueEmPagesModule : ScaffoldModule
    {
        public VueEmPagesModule()
            : base("Vue EmPages", InstanceType.WebModule, false)
        {
            Order = 20;
        }
