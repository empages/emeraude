...
namespace Emeraude.Infrastructure.Localization.Migrations
{
    ...
    [Migration("20211001231638_Init_V2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.ContentKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.Language", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.StaticContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.TranslationKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.TranslationValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.StaticContent", b =>
                {
                    b.HasOne("Emeraude.Contracts.Localization.ContentKey", "ContentKey")
                        .WithMany("StaticContentList")
                        .HasForeignKey("ContentKeyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Emeraude.Contracts.Localization.Language", "Language")
                        .WithMany("StaticContentList")
            ...
            modelBuilder.Entity("Emeraude.Contracts.Localization.TranslationValue", b =>
                {
                    ...
                    b.HasOne("Emeraude.Contracts.Localization.TranslationKey", "TranslationKey")
                        .WithMany("Translations")
