...
public class EmPagesExceptionFilter : ExceptionFilterAttribute
{
    ...
    public EmPagesExceptionFilter()
    {
        ...
        {
            typeof(EmPageDisabledOperationException),
            typeof(EmPageNotFoundException),
            typeof(EmPageAuthorizationException),
            typeof(EmPageInvalidSchemaDefinitionException),
            typeof(EmPageMissingConfigurationException),
            typeof(EmPageUndefinedDataStrategyException),
        };
    }
