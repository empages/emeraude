using Definux.Emeraude.Admin.ClientBuilder.Modules.Vue.StaticContent.Templates;
...
namespace Definux.Emeraude.Admin.ClientBuilder.Modules.Vue.StaticContent
{
    public class VueStaticContentModule : ScaffoldModule
    {
        public VueStaticContentModule()
            : base("Vue Static Content", InstanceType.WebModule, true)
        {
