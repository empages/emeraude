using Definux.Emeraude.Admin.ClientBuilder.Modules.Xamarin.TranslationsResources.Templates;
...
namespace Definux.Emeraude.Admin.ClientBuilder.Modules.Xamarin.TranslationsResources
{
    public class XamarinTranslationsResourcesModule : ScaffoldModule
    {
        public XamarinTranslationsResourcesModule()
            : base("Xamarin Translations Resources", InstanceType.MobileModule, true)
        {
