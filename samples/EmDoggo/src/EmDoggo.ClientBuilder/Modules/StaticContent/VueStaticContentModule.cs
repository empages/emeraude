...
using EmDoggo.ClientBuilder.Modules.StaticContent.Templates;
using EmDoggo.ClientBuilder.Shared;
using Microsoft.EntityFrameworkCore;

namespace EmDoggo.ClientBuilder.Modules.StaticContent
{
    /// <summary>
    ...
    public class VueStaticContentModule : VueScaffoldModule
    {
        ...
        {
            string relativePath = Path.Combine(this.Options.GetVueClientAppPath(), VueAppFolders.Components, VueAppFolders.StaticContent);
        ...
        {
            string relativePath = Path.Combine(this.Options.GetVueClientAppPath(), VueAppFolders.Components);
