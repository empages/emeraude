...
namespace Definux.Emeraude.AutoGenerated.ServiceAgents
{
    public class DogsServiceAgent : ServiceAgent, IDogsServiceAgent
    {
        ...
        public async Task<MutationResultBindable> AddDogAsync(AddDogCommandBindable request)
        {
	        return await PostAsync<AddDogCommandBindable, MutationResultBindable>($"/api/dogs/add", request);
        }
    }
}