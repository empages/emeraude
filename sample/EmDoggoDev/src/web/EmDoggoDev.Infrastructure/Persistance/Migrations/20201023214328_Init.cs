...
namespace EmDoggoDev.Infrastructure.Persistance.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopFoods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopFoods_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopFoods_Shops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopFoods_FoodId",
                table: "ShopFoods",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopFoods_ShopId",
                table: "ShopFoods",
                column: "ShopId");
