            ...
            <b-row>
                <b-col md="6">
                    ...
                    <b-form-group :label="$t('DOG_TYPE')">
                        <enum-b-select v-model="newDog.type" enumType="EmDoggoDev.Domain.Common.DogType"></enum-b-select>
                    </b-form-group>
                    <b-form-group :label="$t('DOG_BREED')">
                        <enum-b-select v-model="newDog.breed" enumType="EmDoggoDev.Domain.Common.DogBreed"></enum-b-select>
                    </b-form-group>
